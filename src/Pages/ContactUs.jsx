...
function ContactUs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost/cgti_backend/contact.php", {
        method: "POST",
  ...
  return (
    <>
      ...
      <div className="w-full h-[450px] lg:h-[550px] mt-0">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3494.4252132153156!2d78.26272599356918!3d30.085775079023144!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39093f2d1f679cf3%3A0x9ad4907d5c7e26b!2z4KSV4KSC4KSq4KWN4KSv4KWC4KSf4KSwIOCkl-ClgeCksOClgSDgpJ_gpY3gpLDgpYfgpKjgpL_gpILgpJcg4KSH4KSC4KS44KWN4KSf4KS_4KSf4KWN4KSv4KWC4KSf!5e0!3m2!1shi!2xin!4v1760195704749!5m2!1shi!2xin"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-x-6">
              <div className="bg-blue-700 text-white p-4 rounded-full shadow-md flex justify-center items-center mx-auto sm:mx-0">
                <FontAwesomeIcon icon={faLocationDot} className="text-3xl sm:text-4xl" />
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-x-6">
              <div className="bg-blue-700 text-white p-4 rounded-full shadow-md flex justify-center items-center mx-auto sm:mx-0">
                <FontAwesomeIcon icon={faPhone} className="text-3xl sm:text-4xl" />
              </div>

    ...
    return(
        // Home Slider After
            <section className='mt-8'>
                {/* first Section Start */}
                <div className='lg:flex gap-x-40 px-5 lg:ml-10'>
                   <div className=''>
                     <img src={CGTIHomeMid} alt="" className='lg:w-[100%]'/>
                   </div>
                    <div className='lg:w-130'>
                         <span className="absolute text-[110px] text-[#E3E7ED] lg:mt-[-110px] lg:ml-10 tracking-[10px] font-extrabold select-none">About</span>

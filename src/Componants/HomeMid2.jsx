                ...
                <div className='grid lg:grid-cols-2  w-full px-8 lg:gap-x-4'>
                    ...
                    <div className='space-y-6 text-justify'>
                        ...
                        <ul className='space-y-5 lg:w-[90%]'>
                            <li className='flex tracking-[2px] items-center'> <FontAwesomeIcon icon={faCircleCheck} size="xl" style={{color: "#74C0FC",}} className=''/><span className='ml-15'><strong>Quality Education:</strong> We provide high-quality education with a focus on the latest curriculum and expert instructors dedicated to your success.</span></li>
                            <li className='flex tracking-[2px] items-center'><FontAwesomeIcon icon={faCircleCheck} size="xl" style={{color: "#74C0FC",}} className=''/><span className='ml-15'><strong>Industry Relevance:</strong> Our courses are designed to meet the demands of the ever-evolving technology industry, ensuring that you are well prepared for real-world challenges.</span></li>
                            <li className='flex tracking-[2px] items-center'><FontAwesomeIcon icon={faCircleCheck} size="xl" className=''/><span className='ml-15 tracking-2'><strong>Flexibility:</strong> With flexible scheduling options including 1 Year Diploma, 6 Months Certificate Course, Short Term and Professional Course, we meet your unique needs and commitments.</span></li>
                        </ul>
                    </div>
                </div>
                {/* Second Section Start */}
                 <div className='grid lg:grid-cols-2 w-full px-8 mt-10'>
                    <div className='space-y-6 text-justify lg:mt-20 lg:ml-10'>
                        <span className='lg:text-4xl font-bold tracking-[2px]'>What we do ?</span>
                        <p className='mt-5 mb-10 lg:w-[88%] tracking-[1px]'>We believe that our growth as a training institute goes hand in hand with the growth and success of our students. Everyone in the CGTI family has a responsibility to collaboratively influence the practices, values and tools that make people successful IT professionals. We promote students’ career development by creating opportunities that enable everyone to learn, think and innovate. Here at CGTI Technology, we help people develop their skills through computer software related courses.</p>
                        <button className="border-1 rounded-xl px-6 py-3 bg-[#005EAA] hover:bg-[#D4A017]">
              Explore More
            </button>
                    </div>
                    <div className='flex justify-center lg:w-[full%] mb-8 lg:mb-0'>
                        <img src={CGTIMid2} alt="CGTI Image" className='w-full max-w-md lg:max-w-full rounded-xl lg:mt-4'/>
                    </div>
                </div>
            </section>
        )

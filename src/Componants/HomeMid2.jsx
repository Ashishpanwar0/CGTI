                ...
                <div className='grid lg:grid-cols-2  w-full px-8 lg:gap-x-4'>
                    ...
                    <div className='space-y-6 text-justify'>
                        ...
                        <ul className='space-y-5 lg:w-[90%]'>
                            <li className='flex tracking-[2px]'> <FontAwesomeIcon icon={faCircleCheck} size="xl" style={{color: "#74C0FC",}} className=''/><span className='ml-15'><strong>Quality Education:</strong> We provide high-quality education with a focus on the latest curriculum and expert instructors dedicated to your success.</span></li>
                            <li className='flex tracking-[2px]'><FontAwesomeIcon icon={faCircleCheck} size="xl" style={{color: "#74C0FC",}} className=''/><span className='ml-15'><strong>Industry Relevance:</strong> Our courses are designed to meet the demands of the ever-evolving technology industry, ensuring that you are well prepared for real-world challenges.</span></li>
                            <li className='flex tracking-[2px]'><FontAwesomeIcon icon={faCircleCheck} size="xl" style={{color: "#74C0FC",}} className=''/><span className='ml-15 tracking-2'><strong>Flexibility:</strong> With flexible scheduling options including 1 Year Diploma, 6 Months Certificate Course, Short Term and Professional Course, we meet your unique needs and commitments.</span></li>
                        </ul>
                    </div>
                </div>

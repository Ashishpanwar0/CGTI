    ...
    <section className="pt-15 bg-[#F8FAFC]">
      ...
      <div className="grid lg:grid-cols-2 w-full px-5 mt-10">
        ...
        <div className="justify-center mb-8 lg:mb-0">
          <img
            src={CGTIMid2} alt="CGTI Image" className="w-full max-w-md lg:max-w-[93%] rounded-xl lg:mt-4"
          />
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-x-10">
        ...
        <div className="px-5 lg:ml-12 lg:mt-10">
            <h1 className="text-5xl font-bold mb-5">Develop Your Career</h1>
            <p className="mb-5 w-[90%]">Have you passed class 12th or graduation? Or you want to make your bright future in the field of computer.</p>
          {/* Accordion Items */}
          <AccordionItem

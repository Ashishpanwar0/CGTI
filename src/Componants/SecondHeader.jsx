...
const SecondHeader = ({ bgImage, title, subtitle }) => {
  return (
    <section
      ...
      <h1 className="text-5xl md:text-7xl font-extrabold z-10 tracking-[2px] lg:mt-[-40px]">{title}</h1>
      <p className="text-lg md:text-2xl font-medium relative z-10 mt-2 tracking-[2px] lg:ml-1">
